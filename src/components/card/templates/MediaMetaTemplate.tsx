    ...
    >
      <div className="relative">
        ...
        {categoryName && categoryHref ? (
          <CLink
            href={categoryHref}
            className="absolute left-4 top-4 rounded-md bg-white px-2 py-2 text-xs font-medium text-blue-600"
          >
            {categoryName}
          </CLink>
        ) : null}
      ...
      <div className="flex flex-1 flex-col gap-2 p-4">
        ...
        <div className="mt-auto flex items-center justify-between gap-4 text-xs">
          ...
          {actionLabel ? (
            <CLink href={href} className="shrink-0 font-semibold text-blue-600">
              {actionLabel}
            </CLink>
          ) : null}
        </div>
