            ...
            <li key={item._id} className="group relative">
              ...
              {children.length ? (
                <MenuChildren
                  ...
                  itemClassName="flex min-h-10 items-center gap-2 whitespace-nowrap px-3 text-sm font-medium text-gray-700 hover:bg-gray-50 hover:text-blue-600 focus:bg-gray-50 focus:text-blue-600"
                />
              ) : null}
            </li>
          );
