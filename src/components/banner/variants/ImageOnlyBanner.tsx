...
export function ImageOnlyBanner({ banner }: { banner: BannerRecord }) {
  return (
    <div className="relative aspect-hero-mobile w-full overflow-hidden rounded-xl border border-blue-100 bg-transparent sm:aspect-hero-tablet lg:aspect-hero">
