...
export function InlineForm({
  ...
  return (
    <Panel className="p-4">
      <div className="text-sm font-bold uppercase text-blue-700">{title}</div>
      ...
      <form className="mt-3 flex overflow-hidden rounded-md border border-gray-200" action="#">
        ...
        />
        <Button className="bg-blue-700 px-3 text-xs font-bold uppercase text-white hover:bg-blue-700">
          {actionLabel}
        </Button>
      </form>
    </Panel>
